...
export async function updateOwnTeam(formData: FormData): Promise<ActionResult> {
...
export async function createOwnPlayer(formData: FormData): Promise<ActionResult> {
  return runAction(async () => {
    const { supabase, team } = await requireOwnedTeam();
...
export async function updateOwnPlayer(id: string, formData: FormData): Promise<ActionResult> {
  return runAction(async () => {
    const { supabase, team } = await requireOwnedTeam();
...
export async function deleteOwnPlayer(id: string): Promise<ActionResult> {
  return runAction(async () => {
    const { supabase, team } = await requireOwnedTeam();
